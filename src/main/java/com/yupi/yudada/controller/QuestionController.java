...
public class QuestionController {
    ...
    //region AI生成题目功能
    private static  final  String GENERATE_QUESTION_SYSYTEM_MESSAGE="你是一位严谨的判题专家，我会给你如下信息：\n" +
            "```\n" +
            "应用名称,\n" +
            "【【【应用描述】】】\n" +
            "应用类别，\n" +
            ...
            "```\n" +
            "请你根据上述信息，按照以下步骤来出题\n" +
            "1、要求：题目和选项尽可能地短，题目不要包含序列号，每题的选项数以我提供的为主，题目不能重复\n" +
            "2、严格按照下面的 json 格式输出题目和选项\n" +
            "```\n" +
            "[{\"options\":[{\"values\":\"选项内容\",\"key\":\"A\"},{\"value\":\"\",\"key\":\"B\"}],\"title\":\"题目标题\"}]\n" +
            "```\n" +
